...
Some disadvantage is that connection is totally transparent (VPN server is invisible in the network), so there's no way to change rPi settings or diagnose connection. 
